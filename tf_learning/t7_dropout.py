...
#对数似然代价函数
loss = tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits(labels=y,logits=tf.matmul(L3_drop,w44)+b44)) #此函数已经整合softmax函数运算，所以不需要prediction 函数z
#梯度下降优化器
...
'''
#当keep_prob 值为1.0时的过拟合程度
'''
ccuracy: 0.9644t_accuracy: 0.9645636
v_accuracy: 0.9598t_accuracy: 0.9582545
v_accuracy: 0.9628t_accuracy: 0.9701273
v_accuracy: 0.973t_accuracy: 0.9774727
v_accuracy: 0.9738t_accuracy: 0.9793636
v_accuracy: 0.9732t_accuracy: 0.98045456
v_accuracy: 0.977t_accuracy: 0.98285455
v_accuracy: 0.9746t_accuracy: 0.9825091
v_accuracy: 0.9772t_accuracy: 0.9842
v_accuracy: 0.9734t_accuracy: 0.98252726
v_accuracy: 0.976t_accuracy: 0.98356366
可以看出其对训练数据的拟合程度相对较高
'''